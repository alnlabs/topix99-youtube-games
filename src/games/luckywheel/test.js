...
const game = new GameClass(); // Create instance for test mode
...
async function start() {
  try {
    ...
    // Assets folder is at root level, so go up 3 levels from src/games/luckywheel/test.js
    const assetsPath = path.join(__dirname, "../../../assets");
    logoImage = await loadImage(path.join(assetsPath, "images/logo.png")).catch(() => {
