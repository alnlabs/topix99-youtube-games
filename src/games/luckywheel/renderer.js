...
function registerFonts() {
  try {
    // Assets folder is at root level, so go up 3 levels from src/games/luckywheel/renderer.js
    ...
    registerFont(path.join(assetsPath, "fonts/BebasNeue-Regular.ttf"), {
      family: "Bebas",
    });
    registerFont(path.join(assetsPath, "fonts/LeagueSpartan-Bold.ttf"), {
      family: "League",
    });
